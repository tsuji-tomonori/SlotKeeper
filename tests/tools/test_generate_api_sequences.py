...
"""
    ...
    assert endpoint_status_codes(function) == (201, 401, 422, 429, 500, 503, 400, 409)
...
"""
    ...
    assert implicit_router_error_returns(function) == (
        ErrorReturnStep(401, MISSING_PRINCIPAL_CONDITION, MISSING_PRINCIPAL_DETAIL),
        ErrorReturnStep(422, REQUEST_VALIDATION_CONDITION, REQUEST_VALIDATION_DETAIL),
    )
...
"""
    ...
    assert endpoint_status_codes(function) == (202, 418, 401, 422, 429, 500, 503, 404)
