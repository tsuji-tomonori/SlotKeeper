...
TOOL_SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        outputs=("docs/spec/40.apis/*/*/interface_gen.md",),
    ...
    ToolSpec(
        name="generate_db_table_specs",
        command="uv run python -m tools.generate_db_table_specs",
        category="docs",
        summary="DDL からテーブル定義書を生成する。",
        inputs=("src/db/ddl.sql",),
        outputs=("docs/spec/20.db/tables/*.gen.md",),
        depends_on=(),
        check_supported=True,
        safe_to_run_in_ci=True,
        examples=(
            "uv run app-docs generate",
            "uv run python -m tools.generate_db_table_specs --check",
        ),
    ),
    ToolSpec(
