...
| `403` | 呼び出し元が資源を管理できる管理者でない場合。 | `application/json` | 12 field(s) |
| `422` | bodyがOpenAPIスキーマの型や制約に一致しない場合。 | `application/json` | 12 field(s) |
...
| `error.details[].resource.name` | `string \| null` | no | 登録しようとした資源名です。 | minLength=1, maxLength=100 |
