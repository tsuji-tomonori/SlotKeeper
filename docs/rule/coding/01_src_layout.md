...
- `src/app/integrations/**/*_provider/*.py` と integration の `deps.py` 以外の `src/app/**/*.py` から provider import を行わない。
...
| LAYOUT-DONT-001 | MUST NOT | `integration_provider_boundary` | - | `src/app/integrations/**/*_provider/*.py` と integration の `deps.py` 以外の `src/app/**/*.py` から provider import を行わない。 |
