...
SQL は operation の `sql/` に置き、`src/tools/generate_queries.py` が `generated/queries.py` を生成する。現行 SQL は PostgreSQL 方言（Aurora DSQL互換）、`@name` placeholder、table alias を使う。
