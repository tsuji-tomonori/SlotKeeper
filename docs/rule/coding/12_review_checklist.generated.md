...
- [ ] `src/app/integrations/**/*_provider/*.py` と integration の `deps.py` 以外の `src/app/**/*.py` から provider import を行わない。 (`LAYOUT-DONT-001`, **MUST NOT**, `[checker:integration_provider_boundary]`)  `source:01_src_layout.md:27`
...
- [ ] API operation から `src/app/integrations/{resource}/*_provider/client.py` を import しない。 (`INTEGRATION-DONT-002`, **MUST NOT**, `[checker:functions_no_provider_imports]`)  `source:08_integrations.md:28`
